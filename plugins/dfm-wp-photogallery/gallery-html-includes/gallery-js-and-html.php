...
<script id="carouselTemp" type="text/x-handlebars-template">
	...
	<ol class="carousel-indicators">
		...
		{{/ImageElement}}
		<li style="display:none;" data-target="#carousel" class="directional" id="prev_indicator" data-slide="prev">&lsaquo;</li>
		<li style="display:none;" data-target="#carousel" class="directional" id="next_indicator" data-slide="next">&rsaquo;</li>
	</ol>
	{{/ImageElementCollection}}
</script>
