...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="xmldocument" >
    ...
    <onl:story xmlns:onl="http://www.saxotech.com/online" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.saxotech.com/online story.xsd">
      ...
      <onl:metadata  source="none" rating="0" comments="false" paystatus="0" priority="2" storytype="standard" multimedia="list">
        ...
        <onl:category>
          <xsl:attribute name="id">
            <xsl:value-of select="normalize-space(fields/category_saxo)"/>
          </xsl:attribute>
        </onl:category>
        <onl:seolabels>
          <onl:seolabel main="1">
