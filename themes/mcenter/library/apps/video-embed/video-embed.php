...
class GPPVideoEmbedder {
	...
	function getVideoPlayer() {
	    ...
	    <div id="flvplayer"><img src="' . get_bloginfo('template_directory') . '/images/video.jpg"></div>
        <script type="text/javascript">
        	var so = new SWFObject("' . get_bloginfo('template_directory') . '/library/apps/video-embed/video-player.swf", "swfplayer", "' . $width . '", "' . $height . '", "9", "#000000"); // Player loading
