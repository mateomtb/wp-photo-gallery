...
.box,.postmetadata,.nav,#sidebar ul li a:hover,ul.txt li:hover {background: #<?php echo $border_color; ?>; }
...
.welcomebox h2, .welcomebox h6, .welcomebox p {color:#<?php echo $font_color; ?>}
