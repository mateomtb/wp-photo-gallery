...
$options = array (
			    ...
			    array(	"name" => "Show Header Links",
						"desc" => "Check this option to show links in the logo bar",
			    		"id" => $shortname."_header_links",			    		
			    		"type" => "checkbox",
			    		"std" => "true"),
					    							    
				array(	"name" => "Header Link Color",
					    "id" => $shortname."_header_link_color",
						"desc" => "Set the 8 bit hex color (RGB) of the links in the logo bar here. (#000000)",
					    "std" => $header_link_color,
					    "type" => "text"),
